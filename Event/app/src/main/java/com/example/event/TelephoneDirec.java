...
public class TelephoneDirec extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_telephone_direc);
        ...
        contactsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(TelephoneDirec.this, "Name: " + selectedContact.getName() + ", Phone: " + selectedContact.getPhone(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}